...
# Choose a classifier
    ...
    # Load the xdf
    test_erp.load_offline_eeg_data(filename = "/Users/maziyardowlat/PycharmProjects/bci-essentials-python3/examples/data/p300_example.xdf", format='xdf') # you can also add a subset here
...
with open('channel3P300_actually3.pickle', 'wb') as handle:
