...
# Set some settings
test_erp.classifier.set_p300_clf_settings(n_splits=5, lico_expansion_factor=1, oversample_ratio=0.5, undersample_ratio=0, covariance_estimator='oas')
...
test_erp.main(online=True, training=True, pp_low=0.2, pp_high=15, pp_order=5, plot_erp=False, window_start=0.0, window_end=0.6, print_markers=False, print_training=True, print_fit=True, print_performance=True, print_predict=False)