...
# Select a classifier
    ...
    test_mi.classifier.set_mi_classifier_settings(n_splits=3, type="TS", random_seed=35)
        ...
        # Load the xdf
    test_mi.load_offline_eeg_data(filename  = "/Users/maziyardowlat/PycharmProjects/bci-essentials-python3/examples/data/TeamData/May11/EKL/DSI7/sub-P001/ses-S001/eeg/sub-P001_ses-S001_task-MI_Test_DS7_StandardTrain_run-001_eeg.xdf") # you can also add a subset here
...
with open('May5_game_01.pickle', 'wb') as handle:
