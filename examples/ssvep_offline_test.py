...
test_ssvep.classifier.set_ssvep_settings(target_freqs = [8.33, 10, 12.5])
...
test_ssvep.main(online=False, training=True,print_performance=True,print_predict=True, max_samples=5120)
