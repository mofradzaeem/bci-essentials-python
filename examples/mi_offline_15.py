...
temp = combinations(proper_list, 1)
...
# Select a classifier
    ...
    test_mi.classifier.set_mi_classifier_settings(n_splits=3, type="TS", random_seed=35)
        ...
        # Load the xdf
    test_mi.load_offline_eeg_data(filename  = "/Users/maziyardowlat/PycharmProjects/bci-essentials-python3/examples/data/sub-P001_ses-S001_task-StandardMI_run-001_eeg.xdf") # you can also add a subset here
